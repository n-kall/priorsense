...
- [`priorsense-package`](https://mc-stan.org/priorsense/reference/priorsense-package.md)
  [`priorsense`](https://mc-stan.org/priorsense/reference/priorsense-package.md)
...
- [`powerscale_derivative()`](https://mc-stan.org/priorsense/reference/powerscale_derivative.md)
...
- [`powerscale_plot_dens()`](https://mc-stan.org/priorsense/reference/powerscale-plots.md)
  ...
  [`plot(`*`<powerscaled_sequence>`*`)`](https://mc-stan.org/priorsense/reference/powerscale-plots.md)
...
- [`example_powerscale_model()`](https://mc-stan.org/priorsense/reference/example_powerscale_model.md)
  : Example models for power-scaling sensitivity

## Other functions for exploring sensitivity

- [`powerscale()`](https://mc-stan.org/priorsense/reference/powerscale-overview.md)
...
- [`create_priorsense_data()`](https://mc-stan.org/priorsense/reference/create-priorsense-data.md)
...
- [`create_priorsense_data()`](https://mc-stan.org/priorsense/reference/create-priorsense-data.md)
  : Create data structure for priorsense
- [`log_lik_draws()`](https://mc-stan.org/priorsense/reference/log_lik_draws.md)
  : Extract log likelihood draws
- [`log_prior_draws()`](https://mc-stan.org/priorsense/reference/log_prior_draws.md)
  : Extract log prior draws
- [`predictions_as_draws()`](https://mc-stan.org/priorsense/reference/predictions_as_draws.md)
