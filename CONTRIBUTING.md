...
This outlines how to propose a change to priorsense and is based on
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("stan-dev/priorsense", fork = TRUE)`.
...
Please note that the priorsense project follows the Stan project’s [Code
of
