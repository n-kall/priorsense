...
## moment_match.CmdStanFit <- function(x, psis, ...) {
...
##     unconstrain_pars = unconstrain_pars.CmdStanFit,
##     log_prob_upars = log_prob_upars.CmdStanFit,
##     log_ratio_upars = log_ratio_upars.CmdStanFit,
...
## log_prob_upars.CmdStanFit <- function(x, upars, ...) {
...
## # update fit object according to new parameter values
## update_pars.CmdStanFit <- function(x, upars, save_old_pars = TRUE, ...) {

##   # save originals
##   if (save_old_pars == TRUE) {
##     x$runset$args$model_variables$parameters_old <- x$runset$args$model_variables$parameters_old
##   }
##   # list with one element per posterior draw
...
## log_ratio_upars.CmdStanFit <- function(x, upars, component_fn, selection, ...) {
##   x <- update_pars(x, upars = upars, ...)
