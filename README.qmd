...
[![priorsense status badge](https://n-kall.r-universe.dev/badges/priorsense)](https://n-kall.r-universe.dev)
...
Priorsense supports brms, Stan, JAGS and NIMBLE, along with posterior draws from
other software. Power-scaling sensitivity analysis checks are described in
