...
- Check the [getting started vignette](https://n-kall.github.io/priorsense/getting_started.html) for a simple example
- For a more detailed modelling example see [here](https://n-kall.github.io/priorsense/articles/airquality.html)
