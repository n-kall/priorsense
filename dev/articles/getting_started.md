...
- `brms`:
  [`vignette("priorsense_with_brms")`](https://mc-stan.org/priorsense/dev/articles/priorsense_with_brms.md)
- Stan (`cmdstanr` or `rstan`):
  [`vignette("priorsense_with_stan")`](https://mc-stan.org/priorsense/dev/articles/priorsense_with_stan.md)
- JAGS (`jagsUI` or `R2jags`):
  [`vignette("priorsense_with_jags")`](https://mc-stan.org/priorsense/dev/articles/priorsense_with_jags.md)
- NIMBLE:
  [`vignette("priorsense_with_nimble")`](https://mc-stan.org/priorsense/dev/articles/priorsense_with_nimble.md)
