...
```
    ...
    Likelihood selection: all data
     ...
     b_Intercept 0.006      0.091                                   -
          b_Temp 0.006      0.093                                   -
           sigma 0.062      0.083 potential prior-likelihood conflict
...
all the parameters. Here we will focus on the Bayesian R2, the joint
log-likelihood and the predictions at the minimum, median and maximum of
...
```
    ...
    Likelihood selection: all data
            ...
            variable prior likelihood                           diagnosis
                  R2 0.066      0.268 potential prior-likelihood conflict
...
```
    ...
    Likelihood selection: all data
            ...
            variable prior likelihood                           diagnosis
                  R2 0.069      0.268 potential prior-likelihood conflict
...
![](airquality_files/figure-html/unnamed-chunk-16-1.png)
