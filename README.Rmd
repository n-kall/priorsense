...
unreliable estimates at the cost of some further computation.

```{r ecdf_plot_mm, eval = T, out.width = '70%', out.height = '70%'}
powerscale_plot_ecdf(fit, moment_match = TRUE)
```

```{r quants_plot_mm, eval = T, out.width = '70%', out.height = '70%'}
