...
power-scaling sequence and then use a plotting function.

```{r sequence-nomm, eval = T, out.width = '70%', out.height = '70%'}
...
estimates should not be trusted, moment matching (currently
unavailable for models fit with `cmdstanr`) may help at the expense of
slightly more computation:

```{r sequence-mm, eval = T, out.width = '70%', out.height = '70%'}
