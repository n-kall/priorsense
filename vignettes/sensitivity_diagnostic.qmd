...
vignette: >
  %\VignetteIndexEntry{Interpreting sensitivity diagnostics}
...
is lower than a threshold) or "prior-likelihood conflict" (if both types of
...
prior-likelihood conflict may not be an issue. However, if you did not put
