...
vignette: >
  %\VignetteIndexEntry{Powerscaling sensitivity analysis}
...
```{r}
powerscale_plot_dens(fit, variables = "mu")
```

- Empirical cumulative distribution functions:
```{r}
powerscale_plot_ecdf(fit, variables = "mu")
```

- Quantities:
```{r, fig.width = 12, fig.height = 4}
powerscale_plot_quantities(fit, variables = "mu")
```
