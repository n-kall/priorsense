...
There is no best quantity to check the sensitivity of in all models. What
...
If you are evaluating the model based on some measure, it can be useful to
assess how this measure of performance changes when changing the prior or
likelihood. Examples of measures of model fit include R2, and metrics such as
MAE or RMSE.
