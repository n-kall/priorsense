...
f <- m$sample(data = x$data, iter_sampling = 20000)

d <- f$draws()

ps <- powerscale_sequence(f, lower_alpha = 0.75, length = 5, component = "prior", variable = "mu", moment_match = TRUE)
...
sticker(p, package = "priorsense", filename = "man/figures/logo.png", p_size = 16, p_color = "#221F21", h_fill = "white", h_color = "black", s_width = 2.8, s_height = 1.3, s_x = 0.96, s_y = 1.05, p_x = 0.7, p_y = 1.33)
