...
- Check the \[getting started vignette\] for a simple example
- For a more complex example see [selecting priors to power-scale and
  posterior quantities to
  check](https://n-kall.github.io/priorsense/articles/selecting_prior_and_quantities.html)
